...
export class SnsConfigStack extends Stack {
    constructor(scope: Construct, id: string, props: StackProps) {
        ...
        lambdaRole.addToPolicy(new PolicyStatement({
            resources: ['*'],
            actions: ['sns:Publish', 'sns:CreateTopic', 'sns:Subscribe'],
        }));

        // Define the Lambda function
        const snsLambda = new Function(this, 'snsLambdaFunction', {
            ...
            environment: {
                'SENDER_ID': snsSmsAttr.senderId,
                'MESSAGE_TYPE': snsSmsAttr.messageType
              }
        });
